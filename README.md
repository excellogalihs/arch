...
At the very top you'll see a comment banner like this:
...
You can delete that banner once you start customizing the file — it's just a heads-up that you're looking at the untouched default, not something functional.

**Why?** Hyprland writes this file out fresh the first time it runs, with the banner as a nudge to go customize it. Once you've started editing (which you're doing right now), it no longer serves a purpose.
